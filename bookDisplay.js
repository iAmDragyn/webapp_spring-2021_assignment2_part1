app.component('book-display', {
    ...
    template:
        ...
        `<ul class="col-sm-12 col-md-6 col-xl-4">
            ...
            <img v-if="this.bookObj.volumeInfo.imageLinks.thumbnail != undefined" :src="this.bookObj.volumeInfo.imageLinks.thumbnail">
            <li class= "list-group-item" v-if="this.bookObj.volumeInfo.authors[0] != undefined"> {{ this.bookObj.volumeInfo.authors[0] }} </li>
